...
namespace IOTBackend.API.Migrations
{
    ...
    [Migration("20240524204435_AddedDeviceInstanceModel")]
    partial class AddedDeviceInstanceModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IOTBackend.Domain.DbEntities.DeviceInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IOTBackend.Domain.DbEntities.DeviceInstance", b =>
                {
                    b.HasOne("IOTBackend.Domain.DbEntities.Device", "Device")
                        .WithMany()
